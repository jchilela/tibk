...
urlpatterns = [
    ...
    path('enviomensagem/<int:pk>/reenviar/', views.reenviarEnvioMensagem, name='reenviar_enviomensagem'),
    ...
    path('balanco-financeiro/', views.balanco_financeiro, name='balanco_financeiro'),
    path('balanco-financeiro/excel/', views.balanco_financeiro_excel, name='balanco_financeiro_excel'),
